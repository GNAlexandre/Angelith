...
**Seule `seg` est utilisée.** Mesuré sur les planches réelles du Vol.2 d'*manga A Twin
Gemini* : page 63, la tête `blk` ne propose que 3 boîtes au-dessus de 0,5 — toutes sur du
