...
| Chiffre | Où | Dénominateur |
|---|---|---|
| **5 036** | `README.md`, `CONTRIBUTING.md`, `docs/COMMANDES.fr.md` | `pytest --collect-only -q`, toutes dépendances optionnelles installées, 2026-09-06 |
| **4 979** | — | ce que la boucle courte exécute : `-m "not lent and not modeles"` |
...
| **4 593** | `docs/mesures/creation-import-maj-2026-09-06.md` | le même total **sans PySide6**, soit un écart de **443** — `python -m pytest --collect-only -q -p tools.compte_sans_pyside`, 2026-09-06 |
...
> (4 979 + 57 = 5 036). La divergence à quatre chiffres qui a motivé ce document ne peut plus
